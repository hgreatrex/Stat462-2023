...
4.  You have a been told that houses might be more expensive in the North.
    ...
    -   Create a Simple Linear Regression model to assess the issue - [See this Tutorial](https://psu-spatial.github.io/Stat462-2023/in_S462_Tutorial5LoadingData.html#regression-models)
